...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [285319.334421, 641060.759158, 291469.785056, 644267.155224], maxZoom: 22, minZoom: 8, projection: new ol.proj.Projection({
            code: 'EPSG:23835',
...
map.getView().fit([285319.334421, 641060.759158, 291469.785056, 644267.155224], map.getSize());
