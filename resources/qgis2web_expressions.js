...
function exp_Garis_Batas_Administrasi_3rule0_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('tipe_batas')  == 'Batas Kalurahan');
    } else {
        return (feature.get('tipe_batas')  == 'Batas Kalurahan');
    }
}
...
function exp_Garis_Batas_Administrasi_3rule1_eval_expression(context) {
    // tipe_batas = 'Batas Dusun'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('tipe_batas')  == 'Batas Dusun');
    } else {
        return (feature.get('tipe_batas')  == 'Batas Dusun');
    }
}
...
function exp_Garis_Batas_Administrasi_3rule2_eval_expression(context) {
    // tipe_batas = 'Batas RT'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('tipe_batas')  == 'Batas RT');
    } else {
        return (feature.get('tipe_batas')  == 'Batas RT');
    }
}